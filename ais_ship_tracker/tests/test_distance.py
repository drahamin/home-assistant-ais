...
class DashboardAssetTests(unittest.TestCase):
    ...
    def test_dashboard_and_tv_offer_live_vessel_map_controls(self):
        ...
        self.assertIn("scheduleTvReset", television_script)
        self.assertIn("resetTvMap();refresh()", television_script)
        self.assertIn('id="tv-map-reset" aria-label="Return map to the AIS home location">Home</button>', television)
    ...
    def test_overview_and_tv_maps_reject_stale_weather_and_recenter(self):
        ...
        self.assertIn("tvResetTimer=setTimeout(resetTvMap,30000)", television_script)
