    ...
    with dashboard_lock:
        ...
        return {
            ...
            "config": {
                ...
                "source": "Local AIS-catcher + Rahamin single-key proxy" if RECEIVER_MODE == "sdr" and RAHAMIN_PROXY_ENABLED else "Network AIS input + Rahamin single-key proxy" if RAHAMIN_PROXY_ENABLED else "Local AIS-catcher + optional AISHub" if RECEIVER_MODE == "sdr" else "Network AIS input + optional AISHub",
